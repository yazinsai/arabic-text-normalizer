  ...
  describe("full normalization", () => {
    ...
    it("normalizes Surah Al-Hadid verse 10", () => {
      ...
      expect(normalize(input)).toBe(
        "وما لكم لا تنفقون فى سبيل الله ولله ميراث السموت والأرض لا يستوى منكم من أنفق قبل الفتح وقتل أولئك أعظم درجة من الذين أنفقوا من بعد وقتلوا وكلا وعد الله الحسنى والله بما تعملون خبير"
      );
    });
    ...
    it("normalizes Surah Al-Baqarah verse 177", () => {
      ...
      expect(normalize(input)).toBe(
        "ليس البر أن تولوا وجوهكم قبل المشرق والمغرب ولكن البر منءامن بالله واليوم الءاخر والملئكة والكتب والنبين وءاتى المال على حبه ذوى القربى واليتمى والمسكين وابن السبيل والسائلين وفى الرقاب"
      );
    });
