...
describe("normalize", () => {
  ...
  describe("full normalization", () => {
    it("normalizes Basmala", () => {
      ...
      expect(normalize(input)).toBe("بسم الله الرحمن الرحيم");
    });
    ...
    it("normalizes Surah Al-Hadid verse 10", () => {
      ...
      expect(normalize(input)).toBe(
        "وما لكم لا تنفقون فى سبيل ٱلله ولله ميراث ٱلسموت وٱلأرض لا يستوى منكم من أنفق قبل ٱلفتح وقتل أولئك أعظم درجة من ٱلذين أنفقوا من بعد وقتلوا وكلا وعد ٱلله ٱلحسنى وٱلله بما تعملون خبير"
      );
    });
    ...
    it("normalizes Surah Al-Baqarah verse 177", () => {
      ...
      expect(normalize(input)).toBe(
        "ليس ٱلبر أن تولوا وجوهكم قبل ٱلمشرق وٱلمغرب ولكن ٱلبر منءامن بٱلله وٱليوم ٱلءاخر وٱلملئكة وٱلكتب وٱلنبين وءاتى ٱلمال على حبه ذوى ٱلقربى وٱليتمى وٱلمسكين وٱبن ٱلسبيل وٱلسائلين وفى ٱلرقاب"
      );
    });
